...
Bij de keuze voor de juiste encoding speelt de beoogde toepassing, of toepassingen, een belangrijke rol. Hierbij is de keuze van de meest geschikte encoding van groot belang. Vaak is het nodig of op zijn minst handig om de data in verschillende encodings aan te bieden. Inzicht in de beoogde toepassing helpt bij het beslissen van de soorten geometrie die nodig zijn. Is 3D data nodig? Is nauwkeurigheid van belang? Worden complexe geometrietypes gebruikt? Kortom: wordt de geometrie data gebruikt voor analyse en is validatie van toepassing, of is ontsluiting van de data en visualisatie het uitgangspunt? Het antwoord op deze vraag is bepalend voor het kiezen van een encoding. Daarnaast is het belangrijk om te kijken naar de behoeftes en tools in gebruik door afnemers - ondersteunen deze de encodings ook?  Dit betekent dat de beste oplossing kan variëren, en afhankelijk is van overwegingen die de data-eigenaar zal moeten maken. 
