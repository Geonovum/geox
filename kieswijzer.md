...
### Nauwkeurige data
Als er sprake is van nauwkeurige geometrische data, kan dit gevolgen hebben voor de formaatkeuze. Dit hangt samen met coördinaatreferentiesystemen. Sommige formaten ondersteunen alleen het WGS-84 coördinaatstelsel, waarmee het niet mogelijk is om coordinaten in Nederland net zo nauwkeurig uit te drukken als bijvoorbeeld in het Rijksdriehoekstelsel. 
